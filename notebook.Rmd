...
Eine einfache Ansicht die zeigt, welche Gebiete bereits ausgezählt sind und welche noch fehlen wurde gewünscht. 

Dass das Geschlecht nicht in allen Exports zu Kandidierenden enthalten war, hat am Montag anch den Wahlen zu Mehrarbeit geführt. Der automatische Export des Geschlechts kann leider erst beim nächsten Release Wahl- und Abstimmungssoftware berücksichtigt werden. Für die National- und Ständeratswahlen im Herbst überlegen wir uns einen Workaround. 
